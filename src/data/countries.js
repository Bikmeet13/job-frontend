export const COUNTRIES = [
  ...
  ["cv", "Cabo Verde"], ["kh", "Cambodia"], ["cm", "Cameroon"], ["ca", "Canada"], ["cf", "Central African Republic"], ["td", "Chad"], ["cl", "Chile"], ["cn", "China"], ["co", "Colombia"], ["km", "Comoros"], ["cd", "Congo (Democratic Republic)"], ["cg", "Congo (Republic)"], ["cr", "Costa Rica"], ["ci", "Cote d'Ivoire"], ["hr", "Croatia"], ["cu", "Cuba"], ["cy", "Cyprus"], ["cz", "Czechia"],
  ...
  ["tw", "Taiwan"], ["tj", "Tajikistan"], ["tz", "Tanzania"], ["th", "Thailand"], ["tl", "Timor-Leste"], ["tg", "Togo"], ["to", "Tonga"], ["tt", "Trinidad and Tobago"], ["tn", "Tunisia"], ["tr", "Turkiye"], ["tm", "Turkmenistan"], ["tv", "Tuvalu"],
  ...
  ["xk", "Kosovo"], ["hk", "Hong Kong"], ["mo", "Macao"],
].map(([code, name]) => ({ code, name }));

export const COUNTRY_NAMES = Object.fromEntries(COUNTRIES.map(({ code, name }) => [code, name.toLowerCase()]));
