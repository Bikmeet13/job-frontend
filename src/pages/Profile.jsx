...
function Profile() {
  ...
  const uploadFile = async (type, selectedFile = null) => {
    const file = selectedFile || (type === "image" ? profileImage : resume);
