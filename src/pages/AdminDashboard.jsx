...
const loadEmployerModeration = async () => {
  setEmployerModerationLoading(true);
  try {
    ...
    console.error("Could not load employer moderation", error);
    toast.error(error.response?.data?.error || "Could not load employer requests. Please refresh.");
  } finally { setEmployerModerationLoading(false); }
};
